...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          leading: Icon(Icons.fitness_center), // Add an icon to the left
          title: Padding(
            padding:
                const EdgeInsets.only(left: 8.0), // Add padding to the title
            child: Text('Workout App'),
          ),
          actions: [
            Padding(
              padding:
                  const EdgeInsets.only(right: 16.0), // Add padding to the icon
              child: CircleAvatar(
